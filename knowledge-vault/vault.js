(() => {
  ...
  const OPEN_ACCESS_VISUALS = Object.freeze({
    ...
    "architecture-design-living:2:2": Object.freeze({
      sectionId: "vi-du",
      src: "assets/explainers/architecture-dymaxion-cutaway-habs.webp",
      alt: "Bản vẽ HABS dạng isometric cắt lớp cho thấy khung tròn, cột trung tâm, hệ sườn mái và cách các bộ phận của Dymaxion House liên kết thành một hệ thống.",
      credit: "Historic American Buildings Survey, Dymaxion House, sheet 6 · Library of Congress",
      rights: "No known restrictions on this U.S. government image",
      source: "https://www.loc.gov/pictures/item/mi0681.sheet.00006a/",
    }),
    ...
    "self-psychology:4:3": Object.freeze({
      sectionId: "khac-biet",
      src: "assets/explainers/self-psychology-wellness-wheel-samhsa.webp",
      alt: "Bánh xe sức khỏe toàn diện của SAMHSA liên kết tám chiều: cảm xúc, môi trường, tài chính, xã hội, tinh thần, nghề nghiệp, thể chất và trí tuệ.",
      credit: "Substance Abuse and Mental Health Services Administration, SAMHSA Wellness Wheel, Exhibit 7.2",
      rights: "Creative Commons Public Domain License; reproduced unaltered with attribution; no endorsement implied",
      source: "https://www.ncbi.nlm.nih.gov/books/NBK571038/box/ch7.b2/?report=objectonly",
    }),
    "communication-conflict:2:1": Object.freeze({
      sectionId: "cach-hoat-dong",
      src: "assets/explainers/communication-active-listening-cdc-p1.webp",
      alt: "Hướng dẫn active listening của ATSDR/CDC đối chiếu nguyên tắc và ví dụ thực hành: kiên nhẫn, để người nói dẫn dắt, diễn giải lại, hỏi câu mở, giữ khoảng lặng và dùng ngôn ngữ cơ thể phù hợp.",
      credit: "Agency for Toxic Substances and Disease Registry, A Guide to Active Listening, page 1",
      rights: "Public domain; reproduced as a complete, unaltered page with ATSDR/CDC attribution; no endorsement implied",
      source: "https://www.atsdr.cdc.gov/community-engagement-playbook/media/pdfs/2024/07/active-listening-guide-508.pdf",
    }),
    "relationships-boundaries:1:1": Object.freeze({
      sectionId: "cach-hoat-dong",
      src: "assets/explainers/relationships-social-connection-components.webp",
      alt: "Ba thành phần của kết nối xã hội: cấu trúc là số lượng và độ đa dạng quan hệ, chức năng là nhu cầu mà quan hệ đáp ứng, và chất lượng là mặt tích cực hoặc tiêu cực của tương tác.",
      credit: "Office of the U.S. Surgeon General, The Three Vital Components of Social Connection",
      rights: "HHS shareable tool; reused unaltered under HHS syndication guidance; no endorsement implied",
      source: "https://www.hhs.gov/surgeongeneral/reports-and-publications/connection/index.html",
    }),
    "relationships-boundaries:3:3": Object.freeze({
      sectionId: "rui-ro",
      src: "assets/explainers/relationships-digital-control-cdc.webp",
      alt: "Poster với các tin nhắn dồn hỏi người kia đang ở đâu, nói chuyện với ai và vì sao chưa trả lời; dùng để nhận diện khi quan tâm chuyển thành giám sát và kiểm soát qua thiết bị số.",
      credit: "National Center for Injury Prevention and Control (U.S.), Hello? (2020)",
      rights: "Public domain; reproduced unaltered with CDC attribution; no endorsement implied",
      source: "https://stacks.cdc.gov/view/cdc/128347",
    }),
    "relationships-boundaries:5:2": Object.freeze({
      sectionId: "vi-du",
      src: "assets/explainers/relationships-lgbtq-traffic-light-cdc.webp",
      alt: "Bài tập đèn giao thông của CDC phân loại hành vi trong quan hệ thành xanh là lành mạnh, vàng là đáng lo cần thận trọng, và đỏ là không an toàn cần dừng lại và tìm trợ giúp.",
      credit: "National Center for Injury Prevention and Control (U.S.), Red-Yellow-Green Light Activity",
      rights: "Public domain; reproduced as a complete, unaltered page with CDC attribution; no endorsement implied",
      source: "https://stacks.cdc.gov/view/cdc/127734",
    }),
  });
